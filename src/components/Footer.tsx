	...
	return (
		<footer className="p-10 bg-base-200 text-base-content">
			<div className="footer lg:max-w-cs mx-auto">
				<div>
					<a href="https://www.ahmetk.dev/" target="_blank" rel="noreferrer noopener">
				...
				<div>
					...
					<Link href="/movies/popular" className="link link-hover p-1 md:p-0">
						Popular
					</Link>
					<Link href="/movies/trending" className="link link-hover p-1 md:p-0">
						Trending
					</Link>
				</div>
				<div>
					<span className="footer-title p-1 md:p-0">TV</span>
					<Link href="/tv/popular" className="link link-hover p-1 md:p-0">
						Popular
					</Link>
					<Link href="/tv/trending" className="link link-hover p-1 md:p-0">
						Trending
					</Link>
				</div>
				{/* <div>
					<span className="footer-title p-1 md:p-0">Legal</span>
					<Link href="/terms" className="link link-hover p-1 md:p-0">
						Terms of use
					</Link>
					<Link href="/privacy" className="link link-hover p-1 md:p-0">
						Privacy policy
					</Link>
					<Link href="/cookies" className="link link-hover p-1 md:p-0">
						Cookie policy
					</Link>
				</div> */}
			</div>
